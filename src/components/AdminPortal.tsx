      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-18 bg-[var(--color-brand-text)] border-r border-[var(--color-brand-primary)]/30 flex flex-col items-center py-4 space-y-3 shrink-0">
          ...
          >
            ...
            <span className="text-sm uppercase font-bold tracking-wider">Stats</span>
          </button>
          ...
          >
            ...
            <span className="text-sm uppercase font-bold tracking-wider">Content</span>
          </button>
          ...
          >
            ...
            <span className="text-sm uppercase font-bold tracking-wider">Graphs</span>
          </button>
          ...
          >
            ...
            <span className="text-sm uppercase font-bold tracking-wider">Data</span>
          </button>
        </div>
          ...
          {activeTab === "content" && (
            <div className="space-y-4 text-[15px] font-sans">
              ...
              <form onSubmit={handleSaveChurchInfo} className="bg-[var(--color-brand-text)] p-3.5 rounded-2xl border border-[var(--color-brand-primary)]/25 space-y-2.5">
                ...
                {isSavedContent && (
                  <div className="p-2 bg-green-950/70 border border-green-700 text-green-200 rounded flex items-center gap-1.5 text-sm">
            ...
            <div className="p-4 space-y-3.5">
              {emailSentSuccess ? (
                <div className="py-6 text-center space-y-3">
                  ...
                  <div>
                    <h4 className="text-[15px] font-bold font-serif italic text-gray-900">
                ...
                <div className="space-y-3">
                  ...
                  {/* SMTP Error Banner */}
                  {errorMessage && (
                    <div className="p-2.5 rounded-xl bg-red-50 border border-red-200 text-red-800 text-sm leading-relaxed font-sans">
                      <strong className="block font-bold mb-0.5">⚠️ Email Dispatch Failed:</strong>
                      <span className="font-mono text-sm break-words">{errorMessage}</span>
                  ...
                  <div className="pt-2 flex gap-2">
                    <button
                      ...
                      onClick={() => setSelectedAppForAction(null)}
                      className="flex-1 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 text-sm font-bold uppercase tracking-wider rounded-xl transition-colors"
                    >
                      Cancel
                    </button>
                    <button
