...
- **Four of the five station photos are Unsplash stock images**, labelled as specific parish features ("Maria Auxiliadora Patroness Statue", "Miraculous Statue of San Roque"). Only the Main Altar photo is real, from the diocese's own site. The client has chosen to keep them until the field team returns real photography. This is the one place in the app where unverified data is not labelled as such — see rule 1 above.
